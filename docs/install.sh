...
echo ""
echo "Before you deploy any skill, check its README for the credentials it"
echo "needs and what data it sends off the host. Many skills call a"
echo "third-party API; those are not offline and not local-only."
echo ""
